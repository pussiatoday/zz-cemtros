...
Оказалось, что над проектом работает команда из [NYU Langone Health](https://nyulangone.org/), проект [ставит задачей](https://coreem.net/about-us/) осветить основные темы работы в приемнике (176 статей) и существует уже с 2015 года.
...
Итак, ниже идет список [статей с Кориэма](https://coreem.net/core/) (N = 176). Я извлек его оттуда за пару часов до коммита [методом копипасты](http://lurkmore.to/Копипаста).
...
| Статья | Комментарий | YouTube к комментарию |
|--------|-------------|:--------------------:|
