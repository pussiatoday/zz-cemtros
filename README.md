...
| Lisfranc Injuries |  |  |
| [Hip Dislocation](https://coreem.net/core/hip-dislocation/) | Почитал всякие увлекательные техники вправления задних и передних вывихов, сроки, риски, тактику с учетом сопутствующих повреждений, иммобилизацию, сравнение с вывихами в протезе, посмотрел видосы. В конце статьи ссылки на другие статьи (в том числе, кстати, на OrthoBullets) — не читал. А еще оказалось, что в [Радиопидии](https://radiopaedia.org/encyclopaedia/cases/all) — в данный момент 32,735 бесплатных, без регистрации и смс случаев со снимками и скроллабельными томограммками, причем из них 1,273 — по травме. Нужно будет воспользоваться. | [hip dislocation](https://youtube.com/search?q=hip+dislocation) |
